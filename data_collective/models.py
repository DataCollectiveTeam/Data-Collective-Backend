...
class DataVis(models.Model):
    ...
    chart_type = models.CharField(max_length=40)
    chart_title = models.CharField(max_length=40)

    x_axis = models.CharField(max_length=40, default='', blank=True)
    y_axis = models.CharField(max_length=40, default='', blank=True)
